...
#stare from registration.views import activate, register
#https://github.com/bitmazk/django-registration-email/blob/master/registration_email/backends/default/urls.py
