...
def generate_username(email):
    ...
    try:
        ...
        raise Exception('Nie można wygenerować konta. Użytkownik o takim samym adresie email'
            'już istnieje.')
...
#   label=_("Password (repeat)"))
    ...
    def clean_email(self):
        ...
        raise forms.ValidationError(
            'Użytkownik o takim samym mailu już istnieje')
...
# _('A user with that email already exists.'))
    ...
    def clean(self):
        ...
        if data.get('your_name'):
            ...
            raise forms.ValidationError('Proszę wpisać poprawną nazwę')
